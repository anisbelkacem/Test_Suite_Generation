...
class MyChromosomeGeneratorTest {
    ...
    void testGenerateRandomValue() {
        ...
        assertNotNull(generator.generateRandomValue(byte.class), "Generated byte value should not be null");
        assertTrue(generator.generateRandomValue(byte.class) instanceof Byte, "Generated value should be of type Byte");
        
        assertNotNull(generator.generateRandomValue(short.class), "Generated short value should not be null");
        assertTrue(generator.generateRandomValue(short.class) instanceof Short, "Generated value should be of type Short");
